...
import { claimNode, doc, heading, paragraph, textNode } from '@carinyaparc/content-pipeline';
import type { ClaimPolicy, DraftArtifact, SurfaceSpec } from '@carinyaparc/content-pipeline';
